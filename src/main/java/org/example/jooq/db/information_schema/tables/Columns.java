...
import org.example.jooq.db.information_schema.tables.records.ColumnsRecord;
...
public class Columns extends TableImpl<ColumnsRecord> {
	...
	private static final long serialVersionUID = -1682891474;
	 ...
	 */
	public final TableField<ColumnsRecord, String> COLUMN_TYPE = createField("COLUMN_TYPE", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), this, "");

	/**
	 * The column <code>INFORMATION_SCHEMA.COLUMNS.COLUMN_ON_UPDATE</code>.
	 */
	public final TableField<ColumnsRecord, String> COLUMN_ON_UPDATE = createField("COLUMN_ON_UPDATE", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), this, "");
